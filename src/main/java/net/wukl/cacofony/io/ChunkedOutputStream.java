...
public class ChunkedOutputStream extends OutputStream {
     ...
     * socket is handled by the {@link net.wukl.cacofony.server.ConnectionHandler}. If you do want
     * to close the entire socket, throw a
     * {@link net.wukl.cacofony.http.exception.SilentException}. Do note however that this also
